...
class Sort_corners_box:
    ...
    def _get_corners_box(self, image) -> List:
        corners_box = []
    ...
    def _contour_index(self, hierarchy):
    ...
    def _get_original_point(self, image):
        ...
        index = self._contour_index(hierarchy)

        # cv2.drawContours(image,contours,contourIdx=index,color=(0,0,255),thickness=2)
